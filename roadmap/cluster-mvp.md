...
title: "Cluster MVP"
status: active
description: "Playable real-time Cluster game. Only remaining MVP item: expand prompt pool."
...
- [x] Minimum 3-player start gate and host-controlled round flow.
...
- [x] Automated test coverage:
  ...
  - cluster multiplayer e2e for 3-player lobby flow
